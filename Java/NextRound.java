 ...
 * 
 */
class Solver extends NextRound {
	 ...
	 */
	public void solve(String inp,String input) {		
               String nk[]=inp.split(" ");
               String s[]=input.split(" ");
               int n=Integer.parseInt(nk[0]);
               int k=Integer.parseInt(nk[1]);
               int count=0;
               int res=Integer.parseInt(s[k-1]);
           
               if(Integer.parseInt(s[k-1])==0)
               {
               	for(int i=k-2;i>=0;i--)
               	{
               	...
               	else
               	{
               		...
               		{
               			if(Integer.parseInt(s[k-1])==Integer.parseInt(s[i]))
               				count++;
               			else
               				break;
               		}
