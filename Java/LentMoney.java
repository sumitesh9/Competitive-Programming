	...
	public static void main(String[] args) {
		...
		try {
			...
			for (int i = 0; i < cases; i++) {				
				solver.solve(Integer.parseInt(br.readLine()),br.readLine(),Long.parseLong(br.readLine()),Long.parseLong(br.readLine()));
			}
		} catch (IOException e) {
 ...
 * 
 */
class Solver extends LentMoney{
	/*
	 * Logic goes here ...
	...
	public void solve(int n, String inp, long k, long x) {		
                String s[]=inp.split(" ");
                long arr[]=new long[n];
                for(int i=0;i<n;i++)
