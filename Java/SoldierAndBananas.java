	...
	public static void main(String[] args) {
		...
		try {
			...
			for (int i = 0; i < cases; i++) {
				...
				solver.solve(Long.parseLong(x[0]),Long.parseLong(x[1]),Long.parseLong(x[2]));
			}
