...
public class HelpAshu {
    ...
    public static int query(int segtree[] , int l , int r , int n , int type) {
        if(l == r)
            return segtree[l + 1];
    ...
    public static void main(String[] args) {
        ...
        while(q-- > 0) {
            ...
            if(type == 1 || type == 2) {
                ...
                int r = f.nextInt();
                if(type == 1)
                    pn(query(tree , l - 1 , r , n , type));
                else
                    pn(((r - l + 1) - query(tree , l - 1 , r , n , type)));
            }
            else
            {
                int pos = f.nextInt();
