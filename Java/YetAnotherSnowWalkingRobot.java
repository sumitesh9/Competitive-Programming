...
public class YetAnotherSnowWalkingRobot {
    ...
    public static void main(String[] args) {
        ...
        while(t --> 0) {
           int n = f.nextInt();
           String str = f.next();
           Map<Point , Integer> hm = new HashMap<Point , Integer>();
           Point point = new Point(0 , 0);
           hm.put(new Point(point) , -1);
           int l = 0 , r = 0 , size = 999999;
           for(int i = 0; i < str.length(); i++) {
                if(str.charAt(i) == 'L')
                    ...
                    point.y--;
                if(hm.containsKey(point) && i - hm.get(point) < size) {
                    l = hm.get(point) + 1;
                    r = i;
                    size = r - l + 1;
                    if(size == 2)
